...
POSTS = [
    ...
    dict(slug="schnauzer-miniatura-suelta-pelo", cat="Cuidados y salud",
         nuevo=True, fecha="9 de junio de 2026",
         titulo="¿El Schnauzer Miniatura suelta pelo? Todo lo que debes saber",
    ...
    dict(slug="alimentacion-cachorro-pienso", cat="Cuidados y salud",
         ...
         titulo="¿Qué pienso darle a tu cachorro? Cómo elegirlo bien y por qué",
    ...
    dict(slug="como-comprar-un-cachorro", cat="Consejos para nuevos dueños",
         ...
         titulo="Guía completa para comprar un cachorro en España",
